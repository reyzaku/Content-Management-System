			...
			<div className="h-full pt-24 mb-20 mt-10 desktop:mx-60 laptop:mx-40 tablet:mx-10 phone:mx-4">
				...
				{show && (
					<div className="flex flex-row gap-4 mt-4 justify-center mb-16">
						...
						<button
							className="text-blue-500 bg-blue-100 transition ease-in-out rounded-lg w-24 h-24 flex flex-col items-center justify-center hover:bg-blue-300 hover:text-blue-700"
							name="paragraf"
							onClick={addBlocks}
						>
							<svg
							...
							<p className="text-xs">Paragraf</p>
						</button>

						{/* Sub Title */}
						<button
							className="text-red-500 bg-red-100 transition ease-in-out rounded-lg w-24 h-24 flex flex-col items-center justify-center hover:bg-red-300 hover:text-red-700"
							name="subtitle"
							onClick={addBlocks}
						>
							<svg
						...
						{/* Image */}
						<button
							className="text-yellow-500 bg-yellow-100 transition ease-in-out rounded-lg w-24 h-24 flex flex-col items-center justify-center hover:bg-yellow-300 hover:text-yellow-700"
							name="image"
							onClick={addBlocks}
						>
							<svg
				...
				<button
					className="px-12 py-3 bg-blue-500 text-white rounded-xl shadow-lg mx-4 mb-8 w-full"
					onClick={createPost}
				>
					Create Post
				</button>
