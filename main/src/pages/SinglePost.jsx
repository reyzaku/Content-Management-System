...
const SinglePost = () => {
	...
	return (
		<>
			<Navbar />
			<div className="bg-white h-full pt-24 mb-48 mt-10 desktop:mx-60 laptop:mx-40 tablet:mx-10 phone:mx-4">
				...
				<div className="flex justify-center mb-8" id="title">
					<h1 className="phone:text-2xl tablet:text-3xl laptop:text-4xl desktop:text-6xl font-bold text-center">
						{article.title}
					</h1>
				</div>
				{/* Creator Container */}
				<div className="flex flex-col items-center mb-24 justify-center">
					<div className="flex flex-row gap-2 items-center mb-16">
						...
						<img
							src={Cover}
							alt=""
							className="phone:w-5 phone:h-5 desktop:w-10 desktop:h-10 rounded-full"
						/>
						{/* article.user.image === undefined ? Cover : article.user.image */}
						{/* ${article.user.firstname} ${article.user.lastname} */}
						<p className="phone:text-sm tablet:text-lg laptop:text-xl desktop:text-xl">
